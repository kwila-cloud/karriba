...
class _EditCustomerPageState extends State<EditCustomerPage> {
  ...
  Widget build(BuildContext context) => WillPopScope(
        onWillPop: () async =>
            _hasChanges() ? await showUnsavedChangesDialog(context, _hasChanges) : true,
        child: Scaffold(
          appBar: AppBar(
            title: Text(_title),
            actions: [
              ...
              child: Column(
                ...
                children: [
                  TextFormField(
                    ...
                    onChanged: (value) => _draftCustomer = _draftCustomer.copyWith(name: value),
                    validator: (value) {
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) => _draftCustomer = _draftCustomer.copyWith(streetAddress: value),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) => _draftCustomer = _draftCustomer.copyWith(city: value),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) => _draftCustomer = _draftCustomer.copyWith(state: value),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                  ...
                  TextFormField(
                    ...
                    onChanged: (value) => _draftCustomer = _draftCustomer.copyWith(zipCode: value),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
